...
<center>
			...
			<a href="index.jsp"><img src="pic/flowers.jpg" class="w3-circle" alt="Norway" style="width: 15%;"></a>
			</div>
			...
			<div class="w3-button w3-bar-item" style="width: 25%;"><a href="user.jsp">User</a></div>
			</div> 
            <h3 style="color: red;">Welcome To User Login Page:</h3>
